                            ...
                            >
                                <div className="item-card-large">
                                    <img
                                        ...
                                        loading="lazy"
                                        onError={(e) => {
                                            e.target.src = `https://via.placeholder.com/88x64/1a1a2e/ffffff?text=${encodeURIComponent(item.name)}`
                                        }}
                                    />
                                        ...
                                        >
                                            ...
                                            {item.countersHeroTypes.length > 0 && (
                                                <div className="counters-info">
                                                    ...
                                                    {item.countersHeroTypes.map((type, i) => (
                                                        <span key={i} className="counter-type">{type}</span>
                                                    ))}
                                                </div>
                                            )}
                                        </motion.div>
